    ...
    <>
      ...
      >
        ...
        >
          ...
          <h1 
            className='
            font-poppins font-semibold ss:text-[72px] 
            text-[52px] 
        ...
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
          <img 
            ...
            z-[5] brightness-100 backdrop-brightness-150 rounded-[32px]' 
          />
          <div 
            className='
          ...
          <div 
            className='
            absolute z-[1] w-[80%] h-[85%] rounded-full bottom-40 white__gradient' 
          />
          <div 
            className='absolute z-[0] w-[50%] h-[55%] right-20 bottom-20 blue__gradient' 
          />
        </div>
